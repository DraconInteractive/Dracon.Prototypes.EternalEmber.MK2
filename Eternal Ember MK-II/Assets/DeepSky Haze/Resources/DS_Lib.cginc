...
#else
	fixed densityIntegral = max(data.dT - kFStartDistance * _ProjectionParams.z, 0) * _DS_InitialDensityParams.z;
...
#endif
	data.rayleigh += _DS_LightColour * kRBetaS * densityIntegral * kSphericalNormFactor;
}
