...
public class MinibufferPrefPane : MonoBehaviour
{
  ...
  public static void ShowHeader() {
    ...
    MakeLink("@shanecelis", "http://twitter.com/shanecelis", "Go to twitter.", EditorStyles.label);
    MakeLink("http://seawisphunter.com", "http://seawisphunter.com", "Go to website.", rightAlign);
  ...
  private static void MakeLink(string label, string url, string tooltip, GUIStyle style) {
