...
public static class MinibufferVersion {
  ...
  public const string majorMinor = "0.3";
  public const string fileVersion = "0.3.541.0";
  public const string semanticVersion = "0.3.0";
  public const string informational = "v0.3.0-5-g643524b";
  public const string versionTimestamp = "2017-08-01T16:06:02EDT";
  public static Dictionary<string, string> metaData = new Dictionary<string, string>() {
    { "git.commit-hash", "643524b" }
    };
