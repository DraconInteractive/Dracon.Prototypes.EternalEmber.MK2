	...
	public class UISlotCooldown : MonoBehaviour {
        ...
        protected void Awake()
        {
            ...
            if (this.m_TargetSlot != null)
            {
                ...
                {
                    (this.m_TargetSlot as UISpellSlot).SetCooldownComponent(this);
                }
            }
            else
            {
        ...
        protected void OnDisable()
		{
            ...
            // Unhook the assign and unassign events
            if (this.m_TargetSlot != null)
            {
                // Check if the slot is a spell slot
                if (this.m_TargetSlot is UISpellSlot)
                {
                    ...
                    // unhook the events
                    slot.onAssign.RemoveListener(OnAssignSpell);
                    slot.onUnassign.RemoveListener(OnUnassignSpell);
                }
            }
        }
        ...
        public void CheckForActiveCooldown()
        {
            ...
            if (this.m_TargetSlot == null || (this.m_TargetSlot is UISpellSlot) == false)
                return;

            // Cast to spell slot
            UISpellSlot spellSlot = (this.m_TargetSlot as UISpellSlot);
